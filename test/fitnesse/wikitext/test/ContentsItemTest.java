...
public class ContentsItemTest extends WikiBaseTestCase {
    ...
    private void assertBuilds(String page, String[] properties, String option, String variable, String result) throws Exception {
        ...
        assertEquals(result + HtmlElement.endl, builder.buildItem(new WikiSourcePage(withProperties(new TestRoot(InMemoryPage.makeRoot("root", injector)).makePage(page), properties))).html());
    }
